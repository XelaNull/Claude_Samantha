...
### Phase 4: IMPLEMENT (`build` Stage 5)
...
- [ ] Recon completed (root cause identified)
- [ ] Fix designed and planned (`build` stages 1–4)
- [ ] I approved the plan
